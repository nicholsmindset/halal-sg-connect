...
const AREA_TYPE_TEMPLATES = {
  business: {
    heroTitle: (name: string) =>
      `Premium Halal Dining in ${name} Business District`,
    heroSubtitle: (name: string) =>
      `Professional halal restaurants, business lunch spots, and corporate catering in Singapore's ${name} area`,
    ...
    seoTitle: (name: string) =>
      `Best Halal Restaurants in ${name} Singapore - Business Dining Guide`,
    seoDescription: (name: string) =>
      `Discover premium halal restaurants in ${name} business district. Professional dining, corporate catering, and business lunch spots with Muslim-friendly services.`,
  },

  residential: {
    heroTitle: (name: string) => `Family-Friendly Halal Restaurants in ${name}`,
    heroSubtitle: (name: string) =>
      `Discover neighborhood halal dining, family restaurants, and community favorites in ${name}`,
    contentIntro: (data: DistrictData) => `
    ...
    `,
    seoTitle: (name: string) =>
      `Family Halal Restaurants in ${name} Singapore - Neighborhood Dining`,
    seoDescription: (name: string) =>
      `Family-friendly halal dining in ${name}. Local favorites, neighborhood restaurants, and community halal food perfect for Muslim families.`,
  },

  cultural: {
    heroTitle: (name: string) => `Authentic Cultural Halal Cuisine in ${name}`,
    heroSubtitle: (name: string) =>
      `Experience traditional halal flavors and cultural dining in Singapore's heritage ${name} district`,
    contentIntro: (data: DistrictData) => `
    ...
    `,
    seoTitle: (name: string) =>
      `Traditional Halal Food in ${name} Singapore - Cultural Heritage Dining`,
    seoDescription: (name: string) =>
      `Authentic traditional halal cuisine in ${name} cultural district. Heritage recipes, cultural dining experiences, and Islamic culinary traditions.`,
  },

  tourist: {
    heroTitle: (name: string) => `Tourist-Friendly Halal Dining in ${name}`,
    heroSubtitle: (name: string) =>
      `International halal cuisine and visitor-friendly Muslim dining experiences in ${name}`,
    contentIntro: (data: DistrictData) => `
    ...
    `,
    seoTitle: (name: string) =>
      `Tourist Halal Restaurants in ${name} Singapore - Visitor Guide`,
    seoDescription: (name: string) =>
      `Muslim-friendly restaurants for tourists in ${name}. International halal cuisine, visitor services, and travel-friendly dining options.`,
  },

  mixed: {
    heroTitle: (name: string) => `Diverse Halal Dining Scene in ${name}`,
    heroSubtitle: (name: string) =>
      `From casual meals to fine dining - explore the complete halal food landscape in ${name}`,
    contentIntro: (data: DistrictData) => `
    ...
    `,
    seoTitle: (name: string) =>
      `Complete Halal Dining Guide for ${name} Singapore`,
    seoDescription: (name: string) =>
      `Comprehensive halal restaurant guide for ${name}. Diverse Muslim dining options from casual to fine dining in Singapore.`,
  },

  industrial: {
    heroTitle: (name: string) => `Worker-Friendly Halal Food in ${name}`,
    heroSubtitle: (name: string) =>
      `Affordable halal meals and practical dining options for the working community in ${name}`,
    contentIntro: (data: DistrictData) => `
    ...
    `,
    seoTitle: (name: string) =>
      `Affordable Halal Food for Workers in ${name} Singapore`,
    seoDescription: (name: string) =>
      `Budget-friendly halal restaurants in ${name} industrial area. Worker meals, affordable dining, and practical Muslim food options.`,
  },

  nature: {
    heroTitle: (name: string) => `Nature-Area Halal Dining Near ${name}`,
    heroSubtitle: (name: string) =>
      `Family-friendly halal restaurants for nature enthusiasts and outdoor activity lovers`,
    contentIntro: (data: DistrictData) => `
    ...
    `,
    seoTitle: (name: string) =>
      `Nature Area Halal Restaurants Near ${name} Singapore`,
    seoDescription: (name: string) =>
      `Family halal dining near ${name} nature areas. Outdoor-friendly restaurants, nature park dining, and family recreation meals.`,
  },

  developing: {
    heroTitle: (name: string) =>
      `Emerging Halal Scene in ${name} New Development`,
    heroSubtitle: (name: string) =>
      `Modern halal dining options in Singapore's newest and most innovative community`,
    contentIntro: (data: DistrictData) => `
    ...
    `,
    seoTitle: (name: string) =>
      `New Halal Restaurants in ${name} Singapore Development`,
    seoDescription: (name: string) =>
      `Modern halal dining in ${name} new development. Contemporary restaurants, innovative cuisine, and future-focused Muslim community dining.`,
  },
};
...
const DINING_DENSITY_INFO = {
  ...
  low: {
    ...
    recommendation:
      'Carefully selected halal restaurants serving the community',
  },
  very_low: {
...
export function generateDistrictContent(data: DistrictData): {
  ...
  return {
    ...
    keywords: [
      ...
      ...data.targetDemographics.map(
        demo => `${demo.toLowerCase()} halal food`
      ),
      ...data.keyFeatures.map(
        feature => `${feature.toLowerCase()} halal restaurants`
      ),
...
export function generatePropertyDistrictContent(data: PropertyDistrictData): {
  ...
  return {
    ...
    keywords: [
      ...
      ...data.targetDemographics.map(
        demo => `${demo.toLowerCase()} halal ${data.code.toLowerCase()}`
      ),
